...
2 - Asegurese de tener un emuladro corriendo o un dispositivo conectado y ejecute el comando "react-native run-android"

3 - En caso de precentar errores, elimine la carpeta node_modules y ejecute el comando
